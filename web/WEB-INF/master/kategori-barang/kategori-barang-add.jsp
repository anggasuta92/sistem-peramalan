                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="kode" name="<%= DbKategoriBarang.COL_KODE %>" placeholder="Masukkan kode kategori" required>
                            </div>
                            <div class="form-group">
                                <label for="nama">Nama</label>
                                <input type="text" class="form-control" id="nama" name="<%= DbKategoriBarang.COL_NAMA %>" placeholder="Masukkan nama kategori" required>
                            </div>
                        </div>
                    </div>
                    <div class="row">
